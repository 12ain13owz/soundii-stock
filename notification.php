<?php 
  ...
  if (isset($_POST['submit'])) {
    $sql = "UPDATE log SET log.read=1 WHERE log.read = 0;";
  ...
  $sql = "SELECT * FROM log INNER JOIN product ON log.id_product = product.id WHERE log.read = 0 ORDER BY log.datetime DESC limit $start,$perpage";
  $query = mysqli_query($connect, $sql);

  $sql2 = "SELECT COUNT(*) as total FROM log WHERE log.read = 0";
    ...
    <main>
      ...
      <div class="table-data">
        <div class="order">
          ...
          <div>
            <ul class="page" style="justify-content: space-between;">
              <form action="notification.php" method="post" style="display: flex;">
                <button type="submit" name="submit" class="btn-submit">อ่านทั้งหมด <?php
                echo "<span style='color: #db504a;'>($amount)</span>";
                ?></button>
              </form>
